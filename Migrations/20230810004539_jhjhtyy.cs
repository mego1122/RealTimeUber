...
{
    public partial class jhjhtyy : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EndLocations", x => x.EndLocationId);
                    table.ForeignKey(
                        name: "FK_EndLocations_Users_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StartLocations", x => x.StartLocationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_EndLocations_EndLocationId",
                        column: x => x.EndLocationId,
                        principalTable: "EndLocations",
                        principalColumn: "EndLocationId");
                    table.ForeignKey(
                        name: "FK_Requests_StartLocations_StartLocationId",
                        column: x => x.StartLocationId,
                        principalTable: "StartLocations",
                        principalColumn: "StartLocationId");
                    table.ForeignKey(
                        name: "FK_Requests_Users_PassengerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EndLocations_ApplicationUserId",
                table: "EndLocations",
